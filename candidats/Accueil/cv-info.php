...
<html lang="en">
    ...
    <body onload="creeCv()">
        <div class="nav-container">
            <nav>
                <div class="user">
                    ...
                    <div class="name_id">
                        <div id="nomcomplet"> <!--JSgetnamefunction--><?php echo"{$Nom} {$Prenom}";?></div>
        ...
        <main>
            ...
            <a href="cv-form.php"><button type="button" class="btn btn-warning" id="modifier" name="modifier">Modifier</button></a>
        </main>
        <footer>
            <!-- place footer here -->
        </footer>
